...
import { FullSlug, getFileExtension, isAbsoluteURL, joinSegments, RSSG } from "../../util/path"
...
import { RssgPluginData } from "../vfile"
...
export const CustomOgImages: RssgEmitterPlugin<Partial<SocialImageOptions>> = (userOpts) => {
