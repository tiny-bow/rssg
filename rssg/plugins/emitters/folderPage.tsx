...
import { ProcessedContent, RssgPluginData, defaultProcessedContent } from "../vfile"
...
import { defaultListPageLayout, sharedPageComponents } from "rssg-layout"
...
export const FolderPage: RssgEmitterPlugin<Partial<FolderPageOptions>> = (userOpts) => {
